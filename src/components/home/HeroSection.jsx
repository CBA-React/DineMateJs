  ...
  return (
    <section className="relative">
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6">
        <div className="min-h-[75svh] lg:min-h-[850px] flex items-end justify-center pb-[100px]">
          <div className="max-w-4xl text-white">
            <h1 className="font-serif font-medium tracking-tight leading-tight text-[88px] text-center">
            ...
            <div className="mt-6 flex flex-wrap justify-center items-center gap-4">
              <Link
                to="/register"
              >
                <SubmitButton text="Join now" withIcon className="px-5 py-2.5 text-base font-medium" />
              </Link>
