      ...
      <div className="px-6 pb-6">
        <div className="flex items-center gap-4 bg-white rounded-[10px] p-4 relative">
          ...
          className="max-w-min text-fade-text"
           ...
           {showEmoji && <EmojiPicker className="bottom-14 left-0" onPick={(emoji) => setValue(value + emoji)} />}
          <input
            value={value}
          ...
          <Button
            onClick={submit}
            className="inline-flex items-center rounded-lg p-1 text-primary max-w-min active:translate-y-[1px]"
          >
